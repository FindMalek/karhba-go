...
export function MarketingAboutComponents(
  ...
  return (
    <div className={cn("bg-background relative flex h-[300px] w-full flex-col items-center justify-center overflow-hidden rounded-lg border md:shadow-xl", className)}>
